...
- Построить сеть дата центра на базе технологий VxLAN, BGP EVPN
- Сеть должна обеспечивать сервисы L2 и L3
- В сети должно быть 2 VRF
- Сеть должна быть безопасно связана с кампусом, Интернетом и удаленными площадками
...
```
### Проверка связи внутри фабрики
Пинг с узла Host-1 всех узлов во всех VLAN и VRF

```
host-1# ping 192.168.2.2 count 1
PING 192.168.2.2 (192.168.2.2): 56 data bytes
64 bytes from 192.168.2.2: icmp_seq=0 ttl=253 time=27.182 ms

--- 192.168.2.2 ping statistics ---
1 packets transmitted, 1 packets received, 0.00% packet loss
round-trip min/avg/max = 27.182/27.181/27.182 ms
host-1# ping 192.168.3.2 count 1
PING 192.168.3.2 (192.168.3.2): 56 data bytes
64 bytes from 192.168.3.2: icmp_seq=0 ttl=249 time=83.98 ms

--- 192.168.3.2 ping statistics ---
1 packets transmitted, 1 packets received, 0.00% packet loss
round-trip min/avg/max = 83.98/83.98/83.98 ms
host-1# ping 192.168.1.3 count 1
PING 192.168.1.3 (192.168.1.3): 56 data bytes
64 bytes from 192.168.1.3: icmp_seq=0 ttl=254 time=56.445 ms

--- 192.168.1.3 ping statistics ---
1 packets transmitted, 1 packets received, 0.00% packet loss
round-trip min/avg/max = 56.445/56.445/56.445 ms
host-1# ping 192.168.2.3 count 1
PING 192.168.2.3 (192.168.2.3): 56 data bytes
64 bytes from 192.168.2.3: icmp_seq=0 ttl=252 time=26.119 ms

--- 192.168.2.3 ping statistics ---
1 packets transmitted, 1 packets received, 0.00% packet loss
round-trip min/avg/max = 26.119/26.118/26.119 ms
host-1# ping 192.168.4.2 count 1
PING 192.168.4.2 (192.168.4.2): 56 data bytes
64 bytes from 192.168.4.2: icmp_seq=0 ttl=249 time=43.673 ms

--- 192.168.4.2 ping statistics ---
1 packets transmitted, 1 packets received, 0.00% packet loss
round-trip min/avg/max = 43.673/43.673/43.673 ms
```

Таблица маршрутов на Leaf-2, где есть все маршруты фабрики и внешние маршруты и шлюз по умолчанию

```
leaf-2# show bgp l2vpn evpn
BGP routing table information for VRF default, address family L2VPN EVPN
BGP table version is 1237, Local Router ID is 10.10.2.4
...
*>e[2]:[0]:[0]:[48]:[5009.0000.1b08]:[0]:[0.0.0.0]/216
                      10.10.1.3                                      0 64600 64701 i
*>e[2]:[0]:[0]:[48]:[5009.0000.1b08]:[32]:[192.168.1.2]/272
                      10.10.1.3                                      0 64600 64701 i
*>e[3]:[0]:[32]:[10.10.1.3]/88
                      10.10.1.3                                      0 64600 64701 i

Route Distinguisher: 10.10.2.3:200
*>e[2]:[0]:[0]:[48]:[aabb.cc00.4000]:[0]:[0.0.0.0]/216
                      10.10.1.3                                      0 64600 64701 i
*>e[2]:[0]:[0]:[48]:[aabb.cc00.4000]:[32]:[192.168.2.2]/272
                      10.10.1.3                                      0 64600 64701 i
*>e[3]:[0]:[32]:[10.10.1.3]/88
                      10.10.1.3                                      0 64600 64701 i

Route Distinguisher: 10.10.2.3:400
*>e[2]:[0]:[0]:[48]:[aabb.cc00.a000]:[32]:[192.168.3.2]/272
                      10.10.1.3                                      0 64600 64701 i

Route Distinguisher: 10.10.2.4:100    (L2VNI 100)
*>e[2]:[0]:[0]:[48]:[5009.0000.1b08]:[0]:[0.0.0.0]/216
                      10.10.1.3                                      0 64600 64701 i
* e                   10.10.1.3                                      0 64600 64701 i
*>l[2]:[0]:[0]:[48]:[aabb.cc00.6000]:[0]:[0.0.0.0]/216
                      10.10.1.5                         100      32768 i
*>e[2]:[0]:[0]:[48]:[5009.0000.1b08]:[32]:[192.168.1.2]/272
                      10.10.1.3                                      0 64600 64701 i
* e                   10.10.1.3                                      0 64600 64701 i
*>l[2]:[0]:[0]:[48]:[aabb.cc00.6000]:[32]:[192.168.1.3]/272
                      10.10.1.5                         100      32768 i
*>e[3]:[0]:[32]:[10.10.1.3]/88
                      10.10.1.3                                      0 64600 64701 i
* e                   10.10.1.3                                      0 64600 64701 i
*>l[3]:[0]:[32]:[10.10.1.5]/88
                      10.10.1.5                         100      32768 i

Route Distinguisher: 10.10.2.4:200    (L2VNI 200)
*>e[2]:[0]:[0]:[48]:[aabb.cc00.4000]:[0]:[0.0.0.0]/216
                      10.10.1.3                                      0 64600 64701 i
* e                   10.10.1.3                                      0 64600 64701 i
...
*>e[2]:[0]:[0]:[48]:[aabb.cc00.4000]:[32]:[192.168.2.2]/272
                      10.10.1.3                                      0 64600 64701 i
* e                   10.10.1.3                                      0 64600 64701 i
*>l[2]:[0]:[0]:[48]:[aabb.cc00.7000]:[32]:[192.168.2.3]/272
                      10.10.1.5                         100      32768 i
*>e[3]:[0]:[32]:[10.10.1.3]/88
                      10.10.1.3                                      0 64600 64701 i
* e                   10.10.1.3                                      0 64600 64701 i
...
Route Distinguisher: 10.10.2.4:600    (L2VNI 600)
*>l[2]:[0]:[0]:[48]:[aabb.cc00.3000]:[0]:[0.0.0.0]/216
                      10.10.1.5                         100      32768 i
*>l[2]:[0]:[0]:[48]:[aabb.cc00.3000]:[32]:[192.168.4.2]/272
                      10.10.1.5                         100      32768 i
*>l[3]:[0]:[32]:[10.10.1.5]/88
                      10.10.1.5                         100      32768 i

Route Distinguisher: 10.10.2.5:100
*>e[2]:[0]:[0]:[48]:[5009.0000.1b08]:[0]:[0.0.0.0]/216
                      10.10.1.3                                      0 64600 64701 i
*>e[2]:[0]:[0]:[48]:[5009.0000.1b08]:[32]:[192.168.1.2]/272
                      10.10.1.3                                      0 64600 64701 i
...
Route Distinguisher: 10.10.2.5:200
*>e[2]:[0]:[0]:[48]:[aabb.cc00.4000]:[0]:[0.0.0.0]/216
                      10.10.1.3                                      0 64600 64701 i
*>e[2]:[0]:[0]:[48]:[aabb.cc00.4000]:[32]:[192.168.2.2]/272
                      10.10.1.3                                      0 64600 64701 i
...
Route Distinguisher: 10.10.2.7:300
*>e[5]:[0]:[0]:[0]:[0.0.0.0]/224
                      10.10.1.6                                      0 64600 64703 64800 i
*>e[5]:[0]:[0]:[24]:[1.1.1.0]/224
                      10.10.1.6                                      0 64600 64703 64800 i
*>e[5]:[0]:[0]:[24]:[1.1.2.0]/224
                      10.10.1.6                                      0 64600 64703 64800 i
*>e[5]:[0]:[0]:[24]:[1.1.3.0]/224
                      10.10.1.6                                      0 64600 64703 64800 i
*>e[5]:[0]:[0]:[24]:[192.168.3.0]/224
                      10.10.1.6                                      0 64600 64703 64800 64704 64600 64701 i
*>e[5]:[0]:[0]:[24]:[192.168.4.0]/224
                      10.10.1.6                                      0 64600 64703 64800 64704 64600 64702 i
*>e[5]:[0]:[0]:[32]:[2.1.1.1]/224
                      10.10.1.6                                      0 64600 64703 64800 64704 ?

Route Distinguisher: 10.10.2.7:500
*>e[5]:[0]:[0]:[0]:[0.0.0.0]/224
                      10.10.1.6                                      0 64600 64703 64800 i
*>e[5]:[0]:[0]:[24]:[1.1.1.0]/224
                      10.10.1.6                                      0 64600 64703 64800 i
...
*>e[5]:[0]:[0]:[24]:[1.1.3.0]/224
                      10.10.1.6                                      0 64600 64703 64800 i
*>e[5]:[0]:[0]:[24]:[192.168.1.0]/224
                      10.10.1.6                                      0 64600 64703 64800 64705 {64600 64701 64702} i
*>e[5]:[0]:[0]:[24]:[192.168.2.0]/224
                      10.10.1.6                                      0 64600 64703 64800 64705 {64600 64701 64702} i
*>e[5]:[0]:[0]:[32]:[2.1.1.1]/224
                      10.10.1.6                                      0 64600 64703 ?

Route Distinguisher: 10.10.2.4:300    (L3VNI 300)
*>e[2]:[0]:[0]:[48]:[5009.0000.1b08]:[32]:[192.168.1.2]/272
                      10.10.1.3                                      0 64600 64701 i
* e                   10.10.1.3                                      0 64600 64701 i
*>e[2]:[0]:[0]:[48]:[aabb.cc00.4000]:[32]:[192.168.2.2]/272
...
Route Distinguisher: 10.10.2.4:500    (L3VNI 500)
*>e[2]:[0]:[0]:[48]:[aabb.cc00.a000]:[32]:[192.168.3.2]/272
                      10.10.1.3                                      0 64600 64701 i
*>e[5]:[0]:[0]:[0]:[0.0.0.0]/224
                      10.10.1.6                                      0 64600 64703 64800 i
