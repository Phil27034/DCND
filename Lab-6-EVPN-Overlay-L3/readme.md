...
- Создаем фейковый VLAN и SVI, привязываем к ним L3 VNI
- Прописываем L3 VNI в nve интерфейсе
...
### Таблица EVPN маршрутов на Leaf-1 - все что нужно получили от Лиф-2: 2 маршрута 3 типа в качестве подписки на BUM траффик, по 2 маршрута типа 2 на каждый адрес и 2 маршрута для L3 VNI
```
Route Distinguisher: 10.10.2.4:100
*>e[2]:[0]:[0]:[48]:[aabb.cc00.6000]:[0]:[0.0.0.0]/216
                      10.10.2.4                                      0 64600 64702 i
*>e[2]:[0]:[0]:[48]:[aabb.cc00.6000]:[32]:[192.168.1.3]/272
                      10.10.2.4                                      0 64600 64702 i
...
*>e[2]:[0]:[0]:[48]:[aabb.cc00.7000]:[0]:[0.0.0.0]/216
                      10.10.2.4                                      0 64600 64702 i
*>e[2]:[0]:[0]:[48]:[aabb.cc00.7000]:[32]:[192.168.2.3]/272
                      10.10.2.4                                      0 64600 64702 i
*>e[3]:[0]:[32]:[10.10.2.4]/88
                      10.10.2.4                                      0 64600 64702 i

Route Distinguisher: 10.10.2.3:300    (L3VNI 300)
*>e[2]:[0]:[0]:[48]:[aabb.cc00.6000]:[32]:[192.168.1.3]/272
                      10.10.2.4                                      0 64600 64702 i
*>e[2]:[0]:[0]:[48]:[aabb.cc00.7000]:[32]:[192.168.2.3]/272
                      10.10.2.4                                      0 64600 64702 i
